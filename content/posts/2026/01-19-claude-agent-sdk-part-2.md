...
My goal today is to make the minimal writing agent from [Part 1]({{< ref "posts/2026/01-12-exploring-claude-agent-sdk.md" >}}) a bit more user-friendly. I'm starting with making the tool calls more descriptive.
