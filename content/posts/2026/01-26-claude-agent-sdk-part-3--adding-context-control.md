...
Building on [Part 1]({{< ref "posts/2026/01-12-exploring-claude-agent-sdk.md" >}}) and [Part 2]({{< ref "posts/2026/01-19-claude-agent-sdk-part-2.md" >}}), today I wanted to add context management to the writing agent. What I discovered instead was a slightly annoying fundamental trade-off in the SDK's design.
...
*This is Part 3 of my series on building with the Claude Agent SDK. [Part 1]({{< ref "posts/2026/01-12-exploring-claude-agent-sdk.md" >}}) covers the basics, [Part 2]({{< ref "posts/2026/01-19-claude-agent-sdk-part-2.md" >}}) adds multi-line input and streaming output.*
